...
export default function SpotCheckTable(props: { tableData: any }) {
          ...
          {selectedRow && (
            <Box>
              ...
              <ModalBody>
                <Box>
                  <Text mb="2">
                    Download the excel template if you don&apos;t already have
                    it for all data, gently fill in the appropriate cells and
                    upload details.
                  </Text>
                  <Text mb="4">
